  ...
  return (
    <div className="flex justify-center mx-4">
      ...
      <div className="container mx-auto my-4 rounded-2xl overflow-hidden">
        ...
        <img className="rounded-full w-56 mx-auto mt-[-8rem] border-8 border-white relative z-10" src={usuario.foto || "https://cdn-icons-png.flaticon.com/128/15678/15678795.png"} alt={`Foto de perfil de ${usuario.nome}`}
				/>
